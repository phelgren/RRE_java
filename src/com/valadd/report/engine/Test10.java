...
public class Test10{
	...
	public static void main(String[] args) {
	    ...
	    // Test 9 is Email an compiled report with Parameters
    ...
    public static boolean runTest(){
    	...
    	String outputFormat = "PDF";
			...
			success = gen.iEmailCompiledReportAlt(sender,recipient,subject, text, reportName, reportOutput, reportParameters, outputFormat);
