...
public class Test1{
    ...
    public static boolean runTest(){
    	...
    	String reportName = "/reports/report_templates/Employee_Listing_new.jrxml";
    	String reportOutput = "/reports/report_output/Employee_List";
    	HashMap reportParameters = null;
    	// Formats: PDF, XLS, HTML, TXT, RTF, CSV, ODT
    	String outputFormat = "ODT";
    	

    		Generator gen = new Generator();
    		
			success = gen.iPrintUnCompiledReport(reportName, reportOutput, reportParameters, outputFormat);
